...
class Model(object):
    ...
    def train_xgb(cf):
        ...
        # 进行预测
        pred_train_data = model.predict(train_data)
        pred_valid_data = model.predict(valid_data)
        ...
        Model.entropy_loss(train_data.get_label(), pred_train_fp)
        ...
        Model.entropy_loss(valid_data.get_label(), pred_valid_fp)
